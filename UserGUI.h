...
public:
    UserModeGUI(Service& service, Repository& repository, ShoppingBasket* ASB, QWidget* parent = NULL);
    ~UserModeGUI();
    ...
    void populateDisplayProducts(int position, vector<TrenchCoat> coats);

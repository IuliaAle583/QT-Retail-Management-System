...
TrenchCoat Repository::getCoat(string size, string color, string photograph) {
    int position = Check(size, color, photograph);
    if (position != -1)
...
void Repository::AddRepo(std::string size, std::string color, int price, int quantity, std::string photograph) {
    int position;
    position = Check(size, color, photograph);
    if (position == -1)
    {
...
int Repository::Check(std::string size, std::string color, std::string photograph) {
...
const std::vector<TrenchCoat>& Repository::getArray() {
...
void Repository::deleteRepo(std::string size, std::string color, std::string photograph) {
    int position;
    position = Check(size, color, photograph);
    if (position != -1)
    {
...
void Repository::soldOut(std::string size, std::string color, std::string photograph) {
    int position;
    position = Check(size, color, photograph);
